...
export default function Hero() {
  ...
  return (
    <div data-aos="fade-up" className="flex flex-col w-full items-center gap-6 pt-10 pb-20 overflow-hidden px-4">
      {/* Header */}
      ...
      <p data-aos="fade-up" data-aos-delay="300" className="text-[#215B63] font-poppins text-[24px] sm:text-[30px] md:text-[36px] text-center font-bold leading-[40px]">
        See PickleCourt in Action
      </p>

      <p data-aos="fade-up" data-aos-delay="600" className="text-[#215B63] font-poppins text-center text-[16px] sm:text-[18px] md:text-[20px] font-bold leading-[32px] md:leading-[40px]">
        A seamless experience for admins and staff to manage
        facilities efficiently
      </p>

      {/* Device Mockups */}
      <div data-aos="fade-up" data-aos-delay="900" className="w-full h-full flex flex-row justify-center items-center overflow-visible ">
        {/* Phone */}
